...
Public Class SendMail
    ...
    Sub Enviar_Correo()
        ...
        _Message.From = New System.Net.Mail.MailAddress("alescano@grupofibrafil.com", "FERRARI", System.Text.Encoding.UTF8) 'Quien lo envía 
    ...
    'End Sub
    'Private Sub SíguenosEnTwitterToolStripMenuItem_Click(ByVal sender As Object, ByVal e As EventArgs) Handles SíguenosEnTwitterToolStripMenuItem.Click
    '    MessageBox.Show("Gracias por apoyar nuesro trabajo", "Muchas gracias Atte. Josué Chavez")
