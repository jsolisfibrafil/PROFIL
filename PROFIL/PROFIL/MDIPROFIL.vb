...
#End Region
    ...
    Private Sub PruebaDeImpresionToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles PruebaDeImpresionToolStripMenuItem.Click
        Dim frm_GRsimple As New FrmPrubaImpresion
        frm_GRsimple.Show()
        frm_GRsimple.MdiParent = Me
    End Sub
End Class
